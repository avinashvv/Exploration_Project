...
|5|should the machine be user friendly?|yes,Machine should be user friendly|o|
...
|8|Do you want signal after process completion|yes,Indication after process completion is needed|f|
|9|can we have size adjustable feature with machine|yes,we need size adjustable sorting machine|o|
|10|how the balls are sorted|Balls are sorted according to size|o|
